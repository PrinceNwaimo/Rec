...
public class ResponseUtils {
    ...
    public static final String ADMIN_REGISTRATION_SUCCESSFULLY = "Admin Registration Successful";

    public static final String ADMIN_DELETED_SUCCESSFULLY = "Admin Deleted Successfully";
